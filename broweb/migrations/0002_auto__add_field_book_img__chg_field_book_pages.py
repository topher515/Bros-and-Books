...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('broweb_book', 'img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Book.pages'
        db.alter_column('broweb_book', 'pages', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Deleting field 'Book.img'
        db.delete_column('broweb_book', 'img')

        # Changing field 'Book.pages'
        db.alter_column('broweb_book', 'pages', self.gf('django.db.models.fields.CharField')(max_length=256))
